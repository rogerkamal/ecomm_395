...
class _SignUpPageState extends State<SignUpPage>
  ...
  Future<void> _submit() async {
    ...
    String contactNo = _contactNo.text.toString();
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const _SubtitleTag(
                                    text:
                                        'Ultra-modern • Secure • Lightning fast',
                                  ),
                                  ...
                                  _FTextField(
                                    ...
                                    validator: (v) {
                                      ...
                                      final hasUpper = v.contains(
                                        RegExp(r'[A-Z]'),
                                      );
                                      final hasLower = v.contains(
                                        RegExp(r'[a-z]'),
                                      );
